...
$reviewRequest = array();
$reviewRequest[ 'reminderDate' ] = '2019-05-22';

$template = array();
$template[ 'variant' ] = 'ReviewCollectorReviewRquestVariantEnum'; // options:
$template[ 'includeWidget' ] = 'false'; 
$reviewRequest[ 'template' ] = $template;
...
$reviewRequest[ 'consumer' ] = $consumer;

$reviewRequests = array();
$reviewRequests[] = $reviewRequest;

$temp = array( 'reviewCollectorReviewRequests' => $reviewRequests );
$data[ 'reviewCollectorRequest' ] = $temp;
...
curl_setopt_array($curl, array(
    CURLOPT_URL            => 'https://api.trustedshops.com/rest/restricted/v2/shops/'. $config[ 'tsID' ] .'/reviews/trigger.json',
